...
* Description: MP mission framework for the Invasion 1944 Mod for ArmA 2 Combined Operations
...
* Contributors: SavageCDN | Wolfenswan
* Documentation: Wolfenswan
* Producers: Wolfenswan
* Special Thanks: Everyone involved in the development of F2 
...
F2 and F2 I44 are composed of many components. Each component is (c) 2007/2008/2009/2010/2011/2012 its respective contributor(s). All rights reserved.

## 04. TERMS OF USE ##

F2 and F2 I44 (hereafter 'Software') contain files to be used in the PC CD-ROM simulators "Armed Assault 2" and "Armed Assault 2: Operation Arrowhead" (hereafter both are referred to as 'ArmA2'). To use the Software you must agree to the following conditions of use:
...
We hope you will enjoy making and updating missions for Invasion 1944 with F2 I44!

~Wolfenswan (wolfenswanarps@gmail.com) (on behalf of all F2 and F2 I44 contributors)
...
* Initial release based on F2 2-7-0
* See the Readme.MD included in F2 for a full F2 Change History
